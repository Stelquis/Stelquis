# 斯坦福 CS146S 精读（三）：Agent Manager——人机协作的最佳实践

> 原文作者：Bruce · 发布于 2026-02-24 · 来源：[heyuan110.com](https://www.heyuan110.com/zh/posts/ai/2026-02-24-agent-manager-patterns/)
...
- **技术判断力**：能评估 AI 生成的代码质量，知道什么能过、什么不能过
- **任务分解力**：能把复杂需求拆成 Agent 能独立完成的子任务
- **沟通精确度**：能用最少的信息量传达最准确的意图

这周的嘉宾是 **Boris Cherney**——[Claude Code](https://www.heyuan110.com/zh/posts/ai/2026-01-14-claude-code-guide/) 的创始人。直接从工具创造者的口中学习如何使用工具，这个含金量不言而喻。

---

## Agent 的自治度光谱

AI 编程 Agent 不是一个二元开关（全自动/纯手动）。它是一个**自治度光谱**。

### 低自治度：简单任务

- **特征**：明确的输入输出、有限的决策空间
- **示例**：重命名变量、添加类型注解、写单元测试
- **管理方式**：直接描述需求，几乎不需要干预
- **时间节省**：接近 100%
...
[CLAUDE.md](https://www.heyuan110.com/zh/posts/ai/2026-01-12-claudemd-memory-guide/) 是 Claude Code 读取的项目级配置文件。它的作用就像"给新员工的入职手册"——告诉 Agent 这个项目的约定、技术栈、编码风格和禁忌。
...
StockApp 团队实现了**约 2.5 倍的生产力提升**，秘诀是一套完整的上下文管理体系。
...
flowchart LR
    subgraph 传统开发者
        A1["手写代码"] --> A2["审查代码"] --> A3["部署代码"]
    end
    subgraph AI辅助开发者
        B1["指导 AI 写代码"] --> B2["审查 AI 代码"] --> B3["部署代码"]
    end
    subgraph AgentManager["Agent Manager"]
        C1["规划任务"] --> C2["配置上下文"] --> C3["管理多个 Agent"] --> C4["审查结果"] --> C5["持续优化"]
    end
    传统开发者 --> AI辅助开发者 --> AgentManager
```
...
- [Claude Code 从入门到精通完全指南](https://www.heyuan110.com/zh/posts/ai/2026-01-14-claude-code-guide/) — Boris Cherney 创造的这个工具，值得深入了解
- [Claude Code 最佳实践](https://www.heyuan110.com/zh/posts/ai/2026-01-06-claudecode-best-practices/) — 创始人亲自分享的使用之道
- [Claude Code Agent Teams 完全指南](https://www.heyuan110.com/zh/posts/ai/2026-02-22-claude-code-agent-teams/) — 从单 Agent 到多 Agent 协作
- [CLAUDE.md 记忆术](https://www.heyuan110.com/zh/posts/ai/2026-01-12-claudemd-memory-guide/) — 项目级上下文管理的核心实践
- [从零手搓一个 Claude Code](https://www.heyuan110.com/zh/posts/ai/2026-02-24-build-magic-code/) — 理解 Agent 底层架构的最佳方式
